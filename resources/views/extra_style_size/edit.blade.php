	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-4 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-heading">Edit Extra operation by STYLE and SIZE:

				{!! Form::open(['method'=>'POST', 'url'=>'/extra_style_size_delete/'.$data->id]) !!}
				...
				<br>
					{!! Form::model($data , ['method' => 'POST', 'url' => 'extra_style_size_update' ]) !!}
					...
					<div class="panel-body">
						...
						@if (isset($operation_list))
							<div class="panel-body">
			                    <p>Choose operation<i></i>: <span style="color:green;"></span></p>
				...
				<div class="panel-body">
					<div class="">
						<a href="{{url('/extra_style_size')}}" class="btn btn-default">Back</a>
					</div>
				</div>
